export default {
    ...
    ECONOMY: {
        ...
        BALANCE_SUBT: "Successfully subtracted {amount} Coins from the {member} Balance!",
    ...
    GAMES: {
        CAPTCHA: {
            ...
            CORRECT_ANSWER: "Your answer was correct, You got {coins} coins to Your Balance!",
    ...
    MODERATION: {
        ...
        TEMPMUTED: "Successfully temporary muted {target}!\nTime: {time}\nReason: {reason}\nModerator: {moderator}",
    ...
    SETTINGS: {
        ...
        LANGUAGE_CHANGED_NOTE: "If you did this by accident, then use the command 'language-reset'",
    },
    ...
    ERRORS: {
        ...
        MEMBER_NOT_KICKABLE: "Cannot kick {target} because he has Immunity for this!",
        ...
        JOIN_BOT_VOICE: "To use this command You need to join Bot Voice Channel!",
        ...
        MISSING_IN_LIST: (value, list) => `"${value}" isn't listed in list!\nChoises: ${list}`,
    ...
    EVENTS: {
        ...
        GUILD_EVENTS: {
            ...
            MEMBER_BOOST: {
                ...
                DESCRIPTION: "{member} just boosted this server!\nServer Boosts: {boosts}",
            },
            MEMBER_UNBOOST: {
                TITLE: "😔 | Member unboosted this Server!",
                DESCRIPTION: "{member} just unboosted this server!\nServer Boosts: {boosts}",
            },

            //guildMemberRoleAdd | guildMemberRoleRemove
            ROLE_ADD: {
                TITLE: "⬆️ | Member Got a Role!",
                DESCRIPTION: "{member} just got a {role} role!\nModerator: {moderator}",
            },
            ROLE_REMOVE: {
                TITLE: "⬇️ | Member Lost a Role!",
                DESCRIPTION: "{member} just lost a {role} role!\nModerator: {moderator}",
            },
        ...
        MESSAGE_EVENTS: {
            DELETE: {
                ...
                DESCRIPTION: "Message from {author} has been deleted by {executor}!\n\n› Message Content: `{content}`\n› Deleted at: {date}",
            },
            UPDATE: {

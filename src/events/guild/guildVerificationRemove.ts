...
export const name: string = 'guildVerificationRemove';
...
export const run: RunFunction = async(client, guild: Guild) => {
    ...
    const title = lang.EVENTS.GUILD_EVENTS.UNVERIFIED.TITLE;
    const description = bold(lang.EVENTS.GUILD_EVENTS.UNVERIFIED.DESCRIPTION);
